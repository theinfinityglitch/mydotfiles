sudo pacman -Syu
sudo pacman -S git clang krita inkscape steam spotify-launcher cmake firefox discord fish github-cli evtest
...
sudo cp disable_keyboard.service /etc/systemd/system/
